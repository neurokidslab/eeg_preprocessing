...
These codes (named ex1_mlt_*) show how to use the function eega_RunAll to apply a set of functions to a dataset.
...
These codes (named ex1_step_*) show how to use the function eega_RunAll to apply a set of functions dedicated to a specific step to a dataset.
