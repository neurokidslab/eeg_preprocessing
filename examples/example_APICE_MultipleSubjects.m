...
% Current path
Path0 = 'C:\Users\an251296\nextCloud\MATLAB\mytoolbox\eeglab2020_0\examples';
...
eega_RunAll( FilesnameIn,...
    ...
    'eega_importdata',              {},...
    'eega_importinfoevents',        {Path2DataEvent, {'ODvo'}},...
...
% APICE
% -------------------------------------------------------------------------
FilesnameIn = ['a_i_is_a_' sprintf('fh%1.0e_fl%d_',filt_highpass,filt_lowpass) '*.set'];
...
eega_RunAll( FilesnameIn,...
    fullfile(P0, FolderData, artfolder),...
    fullfile(P0, FolderData, erpfolder),...
    'eega_latencyevent',        {'DIN1', {'S1' 'S2' 'S3' 'S4' 'SL'}},...
    'eega_removeevent',         {'DIN1',  [], 'all'},...
    'pop_eegfiltnew',           {filt_highpass, [], [], 0, [], [], 0},...
    'pop_eegfiltnew',           {[], filt_lowpass, [], 0, [], [], 0},...
    'eega_epoch',               {Epoch.ev, Epoch.tw},...
    'eega_definefactors',       {{'eventCnd' 'eventItm'}},...
    ...
    'pop_reref',                {[]},...
	'pop_rmbase',               {BL.tw},...
    'eega_avgdatabyfactors',    {{'eventCnd' 'eventItm'}, 'dim2avg', 3},...
...
eega_RunAll( 'a_i_is_a_fh1e-01_fl40_*.set',...
    fullfile(P0, FolderData, artfolder),...
    fullfile(P0, FolderData, erpfolder),...
    'eega_latencyevent',        {'DIN1', {'S1' 'S2' 'S3' 'S4' 'SL'}},...
    'eega_removeevent',         {'DIN1',  [], 'all'},...
    ...
    'pop_rmbase',               {BL.tw},...
    'eega_avgdatabyfactors',    {{'eventCnd' 'eventItm'}, 'dim2avg', 3},...
    'prename', filenameerp, 'saveformat', 'set', 'runto', 2);
