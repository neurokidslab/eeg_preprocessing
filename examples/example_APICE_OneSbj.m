...
FilesnameIn = 'Session 20170602 BB30.raw';
EEG = eega_importdata(fullfile(Path2DataRaw, FilesnameIn) );
EEG = eega_importinfoevents(EEG, Path2DataEvent, {'ODvo'});
...
EEG = eega_latencyevent(EEG, 'DIN1', {'S1' 'S2' 'S3' 'S4' 'SL'});
...
EEG = eega_definefactors(EEG, {'eventCnd' 'eventItm'});
% define Bad Times and Bad Channels
...
EEG = eega_avgdatabyfactors(EEG, {'eventCnd' 'eventItm'}, 'dim2avg', 3);
